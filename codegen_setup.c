...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Future Cop: L.A.P.D.",
    .project_root_env = "FUTURE_COP_LAPD_PROJECT_ROOT",
    .build_dir_env = "FUTURE_COP_LAPD_BUILD_DIR",
    .force_setup_env = "FUTURE_COP_LAPD_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_014.49_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Future_Cop_LAPD",
    .prepare_note =
