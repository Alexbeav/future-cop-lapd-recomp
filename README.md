...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/future-cop-lapd-recomp/total)](https://github.com/Alexbeav/future-cop-lapd-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/future-cop-lapd-recomp/latest/total)](https://github.com/Alexbeav/future-cop-lapd-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/future-cop-lapd-recomp)](https://github.com/Alexbeav/future-cop-lapd-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Future Cop: L.A.P.D.** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLES-01449 disc image
...
|---|---|
| Region | Europe |
| Disc serial | SLES-01449 |
| Discs | 1 |
| Supported dump | Redump `Future Cop - L.A.P.D. (Europe) (En,Fr).cue` as CUE/BIN or CHD |
| BIOS | SCPH-5552 (Europe), 524288 bytes, SHA-256 `1faaa18fa820a0225e488d9f086296b8e6c46df739666093987ff7d8fd352c09` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/future-cop-lapd-recomp/releases)
   and extract it into a writable folder.
2. Start `Future_Cop_LAPD` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Future_Cop_LAPD.exe` and start the game as
usual, or run `Future_Cop_LAPD.exe --diagnostic`. Reproduce the problem, quit, then
run `Future_Cop_LAPD.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
